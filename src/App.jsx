...
export default function App() {
  ...
  const addMonthlyEntry = async () => {
    ...
    const item = { month: mMonth, type: mType, description: mDesc.trim(), amount: amt, account: mType === "Saved" ? mAccount : "" };
  ...
  const posSummary = useMemo(() => {
    ...
    const spendable = positionTotal - fixedTotal - unplannedTotal - tripSavings;
    return { fixedTotal, unplannedTotal, tripSavings, spendable, hasTripBucket: !!tripBucket };
  }, [buckets, ledgerByMonth, posMonth, positionTotal, spends, planned]);
            ...
            <div className="panel" style={{ marginBottom: 16, background: "#EFF5FA", borderColor: "#CBDFEE" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 10, marginBottom: 14 }}>
                <div>
                  ...
                  <div className="serif num" style={{ fontSize: 32, marginTop: 2 }}>{money(positionTotal)}</div>
                </div>
