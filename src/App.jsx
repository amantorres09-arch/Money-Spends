...
export default function App() {
  ...
  const posSummary = useMemo(() => {
    ...
    const savedTotal = forMonth ? forMonth.savedTotal : 0; // Monthly ledger's "Saved" lines for this month
    ...
    // Spendable = what's free after everything already spoken for THIS month:
    // fixed bills, unplanned/misc, this month's own manual savings, and the
    // Trip bucket's running accrual (which is cumulative by design, unlike the
    // other three which reset each month).
    const spendable = projectedTotal - fixedTotal - unplannedTotal - savedTotal - tripSavings;
    return { fixedTotal, unplannedTotal, savedTotal, tripSavings, spendable, hasTripBucket: !!tripBucket, projectedTotal, monthsAhead };
          ...
          <>
            ...
            <div className="panel" style={{ marginBottom: 16, background: "#EFF5FA", borderColor: "#CBDFEE" }}>
              ...
              <div className="grid5">
                ...
                <PosStat label="Saved" sub={monthLabel(posMonth) + " ledger"} value={posSummary.savedTotal} color="#2E7D51" />
