...
// Collapses any reasonable spelling of a month ("2026-7", " 2026-07 ", "2026/07")
// to the one canonical "YYYY-MM" key everything else compares against. Sheet-typed
// months that skip the leading zero would otherwise silently create a duplicate.
